      ...
      <div className="my-8 p-4">
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            it's nearly impossible to reverse-engineer the original prediction
            from the hash.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            the correct message. The smart contract compares this message's hash
            with the stored one. If they match, the original prediction is
